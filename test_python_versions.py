#!/usr/bin/env python3
"""
Test script to verify codebase compatibility across Python versions 3.10, 3.11, 3.12, and 3.13.
This script can be run locally to test imports and basic functionality.
"""
...
def main():
    ...
    if syntax_errors or import_errors or not basic_ok or not cli_ok:
        print("\n❌ Some tests failed!")
        return 1
    else:
        print("\n✅ All tests passed!")
